...
// Database
import Database_EasyRecruit_db from "./Database_EasyRecruit_db.js";

// Controllers
import CandidateController from "../controllers/EasyRecruit_db/CandidateController";
import DocumentsController from "../controllers/EasyRecruit_db/DocumentsController";
import TaskListController from "../controllers/EasyRecruit_db/TaskListController";
import TasksController from "../controllers/EasyRecruit_db/TasksController";
import UserController from "../controllers/EasyRecruit_db/UserController";
...
class Server {
 ...
 // End Init Database
    ...
    // Start Init Controllers
		...
		DocumentsController.init(router);
		TaskListController.init(router);
		TasksController.init(router);
